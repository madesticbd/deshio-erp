          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-200">
              <div className="flex flex-col space-y-3">
                <a href="#" className="text-gray-900 hover:text-red-600 font-medium transition-colors py-2">
                  Home
                </a>
                <a href="#" className="text-gray-700 hover:text-red-600 transition-colors py-2">
                  Shop
                </a>
                <a href="#" className="text-gray-700 hover:text-red-600 transition-colors py-2">
                  Categories
