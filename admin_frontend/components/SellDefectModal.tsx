...
export default function SellDefectModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full transform transition-all animate-in zoom-in-95 duration-200 border border-gray-300 dark:border-gray-600">
        {/* Header */}
        <div className="relative p-6 border-b border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-t-lg">
          <button
            onClick={onClose}
            className="absolute top-6 right-6 p-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors"
            disabled={loading}
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Sell Defective Item</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm">Configure sale details</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-6">
          {/* Product Info Card */}
          <div className="rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/30 p-4">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-mono text-gray-900 dark:text-white">{defect.barcode}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900 dark:text-white">#{defect.productId}</p>
                  </div>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white font-medium focus:ring-1 focus:ring-gray-400 focus:border-gray-400 transition-all placeholder:text-gray-400"
                autoFocus
              />
            </div>
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Enter the discounted price for this defective item</p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 py-2 px-3 border rounded text-sm font-medium transition-all ${
                  sellType === 'pos'
        ...
        <div className="p-6 pt-0 flex gap-3">
          <button
            onClick={onClose}
            disabled={loading}
            className="flex-1 px-4 py-2.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-400 text-white rounded-md transition-all font-medium disabled:cursor-not-allowed"
          >
            {loading ? (
